...
import com.coderask.server.sms.model.CheckCodeTypes;
...
public class AliCheckCodeServiceTest {
    ...
    public void testRepositorySaveOnSendSuccess() throws Exception {
        ...
        var argument = ArgumentCaptor.forClass(CheckCodeRecord.class);
    ...
    public void testValidCode() throws Exception {
        when(checkCodeRecordRepository.findByMobileAndTypeAndCodeAndExpiredTimeBefore(eq("13466718118"),eq(CheckCodeTypes.register),eq("123456"),anyLong())).thenReturn(Optional.of(new CheckCodeRecord()));
